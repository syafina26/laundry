...
if (isset($_POST['simpan'])) {
  ...
  mysqli_query($config, "INSERT INTO services (name, price, description) VALUES ('$service_name', '$price', '$description')");
...
if (isset($_POST['update'])) {
  ...
  mysqli_query($config, "UPDATE services SET name='$service_name', price='$price', description='$description' WHERE id='$id'");
  header("location:?page=service");
  exit;
}
